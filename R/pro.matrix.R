...
#' @encoding UTF-8
#' @export
pro.matrix<-function (mx1, mx2, x, my1 = NULL, my2 = NULL, y, permute.my2 = FALSE, permutations = 999, norm = FALSE, norm.y = FALSE, strata = NULL, seqpermutation = NULL, parallel = NULL, newClusters = TRUE, CL =  NULL) 
{
